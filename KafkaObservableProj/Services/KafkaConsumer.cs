...
namespace KafkaObservableProj.Services
{
    ...
    {
        private EventObservable Observable { get; init; }
        ...
        public KafkaConsumer(EventObservable observable, ILogger<KafkaConsumer> logger)
        {
            Observable = observable;
            Logger = logger;
            Bootstrap = Environment.GetEnvironmentVariable("KAFKA_BOOTSTRAP_SERVERS") ?? "192.168.0.7:9092";
            Topic = Environment.GetEnvironmentVariable("KAFKA_TOPIC") ?? "user-events";
